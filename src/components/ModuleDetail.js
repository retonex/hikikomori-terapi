...
• Toplam 15-20 dakika`
    ...
    'oyun-bagimliligi': {
      ...
      description: 'Bilişsel Davranışçı Terapi yaklaşımıyla oyun bağımlılığını anlama ve yönetme rehberi.',
      goals: [
        'Oyun bağımlılığının belirtilerini tanıma',
        'Tetikleyici faktörleri belirleme',
        'Sağlıklı oyun alışkanlıkları geliştirme',
        'Alternatif aktiviteler bulma',
        'Düşünce ve davranış kalıplarını değiştirme'
      ],
      sections: [
        {
          title: 'Oyun Bağımlılığını Anlamak',
          content: `Oyun bağımlılığı, günlük yaşamı olumsuz etkileyecek düzeyde aşırı ve kontrolsüz oyun oynama davranışıdır. 

Temel Belirtiler:
• Oyun oynamaya ayrılan sürenin giderek artması
• Oyun oynamadığında huzursuzluk ve sinirlilik
• Günlük sorumlulukların aksatılması
• Sosyal ilişkilerin zayıflaması
• Uyku düzeninin bozulması

Bu belirtileri kendinizde gözlemliyorsanız, bu rehber size yardımcı olacaktır.`
        },
        {
          title: 'Bilişsel Yeniden Yapılandırma',
          content: `BDT'nin temel tekniklerinden biri olan bilişsel yeniden yapılandırma, oyunla ilgili düşünce kalıplarınızı değiştirmenize yardımcı olur.

Yaygın Olumsuz Düşünceler:
• "Sadece oyun oynarken mutlu olabiliyorum"
• "Oyun oynamazsam arkadaşlarımı kaybedeceğim"
• "Gerçek hayatta başarılı olamıyorum"

Bu düşünceleri değiştirmek için:
1. Düşüncelerinizi kaydedin
2. Bu düşüncelerin gerçekliğini sorgulayın
3. Alternatif düşünceler geliştirin
4. Yeni düşünce kalıplarını pekiştirin`
        },
        {
          title: 'Davranışsal Stratejiler',
          content: `Oyun oynama davranışınızı kontrol altına almak için pratik stratejiler:

1. Zaman Yönetimi:
• Günlük oyun süresini belirleyin
• Alarm kurun
• Oyun molalarını planlayın

2. Alternatif Aktiviteler:
• Fiziksel egzersiz
• Yeni hobiler edinme
...
3. Çevre Düzenlemesi:
• Oyun cihazlarını görünür yerlerden kaldırma
• Otomatik girişleri kapatma
• Oyun bildirimlerini kapatma`
        },
        {
          title: 'Tetikleyicilerle Başa Çıkma',
          content: `Oyun oynama dürtüsünü tetikleyen faktörleri belirleyin ve yönetin:
...
3. Günlük tutma
4. Destek gruplarına katılma`
        },
        {
          title: 'Sağlıklı Oyun Alışkanlıkları',
          content: `Oyunları tamamen hayatınızdan çıkarmak yerine, sağlıklı bir şekilde oynamayı öğrenin:

Öneriler:
1. Net zaman sınırları belirleyin
2. Oyun çeşitliliğini artırın
3. Sosyal oyunları tercih edin
4. Gerçek hayat hedeflerinizi önceliklendirin
5. Düzenli mola verin
6. Fiziksel aktiviteyle dengeleyin

Hatırlayın: Oyunlar eğlence için vardır, kaçış için değil.`
        }
      ],
      exercises: [
        {
          title: 'Oyun Günlüğü',
          description: 'Bir hafta boyunca oyun oynama sürenizi, tetikleyicileri ve duygularınızı kaydedin.'
        },
        {
          title: 'Düşünce Kaydı',
          description: 'Oyunla ilgili olumsuz düşüncelerinizi ve bunların alternatiflerini yazın.'
        },
        {
